...
// weak / ok / expected / agreements are the quoted-$ Chance buckets and
// Agreements Sent; bfoPipe is the total BFO pipeline $ (plotted on its
// own axis since it runs larger). Keyed by calendar month "YYYY-MM".
