      ...
      <div className="main">
        ...
        <div className="content">
          {dataLoading ? (
            ...
            <OppsView2 settings={settings} updateSettings={updateSettings} prospects={prospects} updateProspect={updateProspect} onAddProspect={addProspect} onSelectProspect={handleSelect} />
          ) : view === 'dropdowns' ? (
