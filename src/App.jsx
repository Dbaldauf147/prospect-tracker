      ...
      <div className="main">
        ...
        <div className="content">
          {dataLoading ? (
            ...
            <ClientsView mode="oldClient" prospects={prospects} onSelectProspect={handleSelect} cdmName={cdmName} settings={settings} updateSettings={updateSettings} />
          ) : view === 'opps' ? (
            <OppsView settings={settings} updateSettings={updateSettings} />
          ) : view === 'opps2' ? (
            <OppsView2 settings={settings} updateSettings={updateSettings} prospects={prospects} updateProspect={updateProspect} onSelectProspect={handleSelect} />
          ) : view === 'dropdowns' ? (
