...
export function ProspectModal({ prospect, prospects = [], onSave, onClose, isNew, hubspotContacts = [], onDeleteContact, orgCharts = {}, onUpdateOrgChart = () => {}, settings = {}, updateSettings = () => {}, targetAccountsData = null }) {
  ...
  const addOpportunity = useCallback((bucketId) => {
    ...
    const notes = [
      ...
      '<li>☐ Requires a decision</li>',
      '<li>☐ Logical, realistic and appropriate for the meeting</li>',
      '<li>☐ Makes no an OK choice</li>',
      '<li>☐ Singular ask for the client?</li>',
      '<li>☐ Should we be talking?</li>',
      '<li>☐ Should we keep talking?</li>',
      '<li>☐ Should you do this?</li>',
      '<li>☐ Should you do this with us?</li>',
      '</ul>',
