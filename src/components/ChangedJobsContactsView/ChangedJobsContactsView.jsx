...
export function ChangedJobsContactsView({ prospects = [], onSelectProspect, settings, updateSettings }) {
  ...
  return (
    <KeyContactsView
      ...
      pageSubtitle={
        <>HubSpot contacts who have changed jobs — either tagged <code>Left</code> or with their Company set to <code>Changed Jobs</code>. Use this to find people you want to chase down at their new employer. Toggle <strong>All Contacts</strong> for a flat name-by-name table or <strong>By Company</strong> to roll them up.</>
      }
