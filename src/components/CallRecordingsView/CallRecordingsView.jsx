    ...
    <div className={styles.wrapper}>
      ...
      {tab === 'calls' && (source === 'granola' ? (
        <div className={styles.controls}>
          ...
          {/* "Backfill next steps on opps" stood here. It was the catch-up
              for the live push that copied a call's follow-ups onto its
              opp's checklist, and that push is gone — a call's follow-ups
              live on the call record and are read back per call by the
              Follow Up Notes popup's Calls tab. A button whose whole job
              was to bulk-copy them into the notes had nothing left to
              catch up to. */}
