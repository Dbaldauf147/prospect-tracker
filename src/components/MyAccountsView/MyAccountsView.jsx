...
import { findTier } from '../../utils/myAccountsTiers';
...
// MY_ACCOUNTS (Dan's tier map) + findTier now live in ../../utils/myAccountsTiers
// so the Pipeline Excel export resolves strategic tiers identically.
