...
// SDK has not been written off outright: it is known not to be answering,
// so this write is a formality that should not cost another minute of
// spinner. A CRASHED client is the other case and keeps the full ceiling —
// the site-list write then goes over HTTPS itself and is a real save worth
// waiting for, not a formality.
