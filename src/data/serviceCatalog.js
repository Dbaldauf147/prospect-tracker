...
export const SERVICE_CATALOG = [
  ...
  { name: 'Rebaseline project',                         bfoTag: '#SUECO', region: 'NAM',    years: '1 year',  productLine: 'SUSUP - SUPPLY & SUST SERVICES', serviceType: 'Project' },
...
export function getEffectiveServiceMetadata(name, overrides) {
  ...
  return {
    ...
    // The other direction: services this one retires once it is sold, again
    // as a comma-separated list of Solutions names with no seed. The status
    // boards read it — see src/utils/serviceAutoNa.js — and show an N/A
    // nobody typed rather than a blank row that looks unexplored.
    autoNa:           override?.autoNa           ?? seed?.autoNa           ?? '',
